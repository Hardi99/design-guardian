      ...
      schemas: {
        ...
        NodeDiff: {
          ...
          properties: {
            ...
            before_svg_b64: { type: 'string', nullable: true, description: 'Base64 SVG of node before change' },
            after_svg_b64: { type: 'string', nullable: true, description: 'Base64 SVG of node after change' },
          },
        },
      },
    },
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      svg_b64: { type: 'string', nullable: true, description: 'Base64 SVG of the current frame' },
                      prev_svg_b64: { type: 'string', nullable: true, description: 'Base64 SVG of the previous frame' },
