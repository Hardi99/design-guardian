...
- **DG :** 300 tests (181 back + 119 plugin) + ≥80 % + CI/CD ✅. **Gaps :** le cahier de recettes attend **REC-AUTH-003 (Facebook OAuth)**, **REC-AUTH-005 (SMS)**, **REC-AUTH-007 (validation email)** → liés aux gaps OAuth×3 et SMS ci-dessous. Vérifier **OpenAPI** par service.
